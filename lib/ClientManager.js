...
class ClientManager {
    ...
    async newClient(id,authusr = null,authpass = null, ipAdr = null) {
        ...
        const secureopts = this.opt.secure;

        this.debug("Creating new TunnelAgent, id:%s, maxSockets: %s, secure: %s", id, maxSockets, secureopts);
        ...
        this.debug("Creating new client, id:%s, authusr: %s,authpass: %s, ip adr: ", id, authusr,authpass, ipAdr);
